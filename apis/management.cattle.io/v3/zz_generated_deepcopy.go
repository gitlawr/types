...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetPipeline) DeepCopyInto(out *TargetPipeline) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetPipeline.
func (in *TargetPipeline) DeepCopy() *TargetPipeline {
	if in == nil {
		return nil
	}
	out := new(TargetPipeline)
